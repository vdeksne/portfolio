...
"[project]/.next-internal/server/app/api/admin/stack/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/admin/stack/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    return Response.json((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$content$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStack"])());
}
async function PUT(req) {
    const denied = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cms$2f$guard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireCmsAuth"])();
    if (denied) return denied;
    const json = await req.json();
    const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cms$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stackSchema"].safeParse(json);
    if (!parsed.success) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$content$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeStackFile"])(parsed.data);
    return Response.json({
        ok: true
    });
}
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__09da08b4._.js.map