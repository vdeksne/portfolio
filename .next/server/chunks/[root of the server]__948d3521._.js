...
async function GET(req) {
    ...
    if (process.env.VERCEL === "1") {
        const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDb"])();
        if (db) {
            const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$projects$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listProjectsFromDb"])(locale);
