...
"[project]/.next-internal/server/app/api/admin/projects/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
;
;
const createBodySchema = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$3$2e$24$2e$2$2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["object"])({
    id: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$zod$40$3$2e$24$2e$2$2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["string"])().regex(/^[a-z0-9][a-z0-9-]{0,120}$/i),
    project: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cms$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectSchema"]
});
async function GET(req) {
    ...
    if (process.env.VERCEL === "1") {
        return Response.json(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$content$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listProjectRowsWithDbOverlay"])(locale));
    }
    return Response.json((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$content$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listProjectRows"])(locale));
}
async function POST(req) {
    ...
    if (process.env.VERCEL === "1") {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$projects$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upsertProjectToDb"])(locale, id, parsed.data.project);
    } else {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$content$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeProjectFile"])(locale, id, parsed.data.project);
    }
    return Response.json({
        ok: true,
        id
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__948d3521._.js.map