...
"[project]/src/lib/cms-json-docs-db.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getExperiencesResolved() {
    if (process.env.VERCEL === "1") {
        const raw = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cms$2d$json$2d$docs$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchCmsJsonDoc"])("experiences");
