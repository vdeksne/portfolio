...
"[project]/.next-internal/server/app/api/admin/faq/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/admin/faq/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    return Response.json((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$content$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFaq"])(locale));
}
async function PUT(req) {
    ...
    const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cms$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["faqSchema"].safeParse(json);
    if (!parsed.success) {
        return Response.json({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$content$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeFaqFile"])(locale, parsed.data);
    return Response.json({
        ok: true
    });
}
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ab3d0b90._.js.map