...
"[project]/.next-internal/server/app/api/admin/projects/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function GET(req, ctx) {
    ...
    if (process.env.VERCEL === "1") {
        const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDb"])();
        if (db) {
            const p = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$projects$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProjectFromDb"])(locale, id.toLowerCase());
            if (p && (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$content$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isCompleteProjectPayload"])(p)) return Response.json(p);
        }
    }
    const project = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$content$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["readProjectFile"])(locale, id);
...
async function PUT(req, ctx) {
    ...
    const parsed = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cms$2f$schemas$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projectSchema"].safeParse(json);
    if (!parsed.success) {
        return Response.json({
    ...
    if (process.env.VERCEL === "1") {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$projects$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["upsertProjectToDb"])(locale, id.toLowerCase(), parsed.data);
    } else {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$content$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["writeProjectFile"])(locale, id.toLowerCase(), parsed.data);
    }
    return Response.json({
        ok: true
    });
...
async function DELETE(req, ctx) {
    ...
    if (process.env.VERCEL === "1") {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$projects$2d$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteProjectFromDb"])(locale, id.toLowerCase());
    } else {
        const readonlyFs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cms$2f$vercel$2d$readonly$2d$guard$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rejectIfVercelCmsFilesystemWrite"])();
        if (readonlyFs) return readonlyFs;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$content$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteProjectFile"])(locale, id);
    }
    return Response.json({
        ok: true
    });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__64525fe8._.js.map