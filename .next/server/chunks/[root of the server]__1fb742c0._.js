...
var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/node:crypto [external] (node:crypto, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$vercel$2b$blob$40$2$2e$3$2e$3$2f$node_modules$2f40$vercel$2f$blob$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@vercel+blob@2.3.3/node_modules/@vercel/blob/dist/index.js [app-route] (ecmascript) <locals>");
...
function resolveExtension(file, buf) {
    ...
    return {
        error: "Could not detect file type. Use PDF or an image (JPEG, PNG, WebP, GIF, SVG, AVIF)."
    };
}
async function POST(req) {
    ...
    /** Production/preview serverless: disk is read-only — Blob required unless token set. `vercel dev` uses VERCEL_ENV=development and can write public/uploads. */ const blobRequiredOnVercel = process.env.VERCEL === "1" && process.env.VERCEL_ENV !== "development" && !process.env.BLOB_READ_WRITE_TOKEN?.trim();
    if (blobRequiredOnVercel) {
        return Response.json({
            error: "Upload requires Vercel Blob. Project → Storage → Blob → create or link a store (sets BLOB_READ_WRITE_TOKEN), or paste an external URL."
        }, {
            status: 503
        });
    }
    ...
    if (blobToken) {
        try {
            ...
            const blob = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$vercel$2b$blob$40$2$2e$3$2e$3$2f$node_modules$2f40$vercel$2f$blob$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["put"])(pathname, buf, {
                access: "public",
                token: blobToken,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1fb742c0._.js.map