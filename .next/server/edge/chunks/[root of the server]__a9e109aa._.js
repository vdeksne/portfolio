...
/** Must not get `/en/...` redirects — crawlers only fetch root URLs from og:image meta tags. */ const SKIP_LOCALE_PREFIX = new Set([
    "/opengraph-image",
    "/twitter-image",
    "/icon",
    "/apple-icon"
